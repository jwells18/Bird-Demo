...
class BRWebController: UIViewController, UIWebViewDelegate, NJKWebViewProgressDelegate{
    ...
    func setupNavigationBar(){
        ...
        let refreshButtonItem = BRBarButtonItem(image: UIImage(named:"refresh"), style: .plain, target: self, action: #selector(self.refreshButtonPressed))
    ...
    func setupWebView(){
        ...
        webProgressView.progressBarView.backgroundColor = BRColor.secondary
    ...
    func setupWebViewToolbar(){
        ...
        self.navigationController?.toolbar.tintColor = BRColor.secondary
